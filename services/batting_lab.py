    ...
    for tier_name, tier_value in TIERS.items():
        ...
        conn.execute(sa_text("""
            ...
            AS new_row ON DUPLICATE KEY UPDATE
                games_played = new_row.games_played,
                plate_appearances = new_row.plate_appearances,
                at_bats = new_row.at_bats,
                hits = new_row.hits,
                doubles_ct = new_row.doubles_ct,
                triples_ct = new_row.triples_ct,
                ...
                avg_score_home = new_row.avg_score_home,
                avg_score_away = new_row.avg_score_away,
                raw_json = new_row.raw_json
        """), {
            "run_id": run_id,
