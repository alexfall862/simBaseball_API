...
--
-- Table structure for table `fa_auction`
--

DROP TABLE IF EXISTS `fa_auction`;
...
--
-- Dumping data for table `fa_auction`
--

LOCK TABLES `fa_auction` WRITE;
/*!40000 ALTER TABLE `fa_auction` DISABLE KEYS */;
/*!40000 ALTER TABLE `fa_auction` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-29  0:07:56
