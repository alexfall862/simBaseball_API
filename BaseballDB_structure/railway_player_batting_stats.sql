...
CREATE TABLE `player_batting_stats` (
  ...
  KEY `fk_batting_ly` (`league_year_id`),
  KEY `fk_batting_team` (`team_id`),
  CONSTRAINT `fk_batting_ly` FOREIGN KEY (`league_year_id`) REFERENCES `league_years` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_batting_player` FOREIGN KEY (`player_id`) REFERENCES `simbbPlayers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_batting_team` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=851167 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Dump completed on 2026-03-17 10:16:34
