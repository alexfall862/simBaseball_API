...
--
-- Table structure for table `ifa_auction`
--

DROP TABLE IF EXISTS `ifa_auction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ifa_auction` (
...
--
-- Dumping data for table `ifa_auction`
--

LOCK TABLES `ifa_auction` WRITE;
/*!40000 ALTER TABLE `ifa_auction` DISABLE KEYS */;
/*!40000 ALTER TABLE `ifa_auction` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-29  0:14:25
