...
--
-- Table structure for table `player_injury_events`
--

DROP TABLE IF EXISTS `player_injury_events`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `player_injury_events` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `player_id` bigint unsigned NOT NULL,
  `injury_type_id` bigint unsigned NOT NULL,
  `league_year_id` bigint unsigned DEFAULT NULL,
  `gamelist_id` bigint unsigned DEFAULT NULL,
  `source` enum('pregame','ingame') NOT NULL DEFAULT 'ingame',
  `weeks_assigned` int NOT NULL,
  `weeks_remaining` int NOT NULL,
  `malus_json` json NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_pie_game_player_type` (`gamelist_id`,`player_id`,`injury_type_id`),
