...
--
-- Table structure for table `level_batting_config`
--

DROP TABLE IF EXISTS `level_batting_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `level_batting_config` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `league_level` int unsigned NOT NULL,
  `inside_swing` float NOT NULL DEFAULT '0.65',
  `outside_swing` float NOT NULL DEFAULT '0.3',
  `inside_contact` float NOT NULL DEFAULT '0.87',
  `outside_contact` float NOT NULL DEFAULT '0.66',
  `modexp` float NOT NULL DEFAULT '2',
  PRIMARY KEY (`id`),
