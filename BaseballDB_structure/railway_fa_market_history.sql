...
--
-- Table structure for table `fa_market_history`
--

DROP TABLE IF EXISTS `fa_market_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `fa_market_history` (
...
--
-- Dumping data for table `fa_market_history`
--

LOCK TABLES `fa_market_history` WRITE;
/*!40000 ALTER TABLE `fa_market_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `fa_market_history` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-03-29  0:05:23
