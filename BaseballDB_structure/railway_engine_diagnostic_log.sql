...
--
-- Table structure for table `engine_diagnostic_log`
--

DROP TABLE IF EXISTS `engine_diagnostic_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `engine_diagnostic_log` (
...
-- Dump completed on 2026-03-17 10:17:34
